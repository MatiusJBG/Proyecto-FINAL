...
class Curso(NodoContenido):
    ...
    def __init__(self, id: int, nombre: str, descripcion: str = "", duracion_estimada: int = 0, id_profesor: Optional[int] = None):
...
class Modulo(NodoContenido):
    ...
    def __init__(self, id: int, nombre: str, descripcion: str = "", duracion_estimada: int = 0, id_curso: int = 0):
        super().__init__(id, nombre)
        self.descripcion = descripcion
        self.duracion_estimada = duracion_estimada
